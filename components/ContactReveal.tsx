    ...
    return (
      ...
      >
        <div className="mb-3 flex items-center gap-2">
          <LockKeyhole className="h-4 w-4" style={{ color: "#e05523" }} />
          <p className="text-sm font-bold text-white">Verified contact access</p>
        </div>
        <div className="mb-4 space-y-2.5">
          {contacts.map((c) => (
            <div key={c.label} className="flex items-center gap-3">
              <c.icon className="h-4 w-4" style={{ color: "rgba(255,255,255,0.30)" }} />
              <span
                className="select-none text-sm font-semibold"
                style={{ color: "rgba(255,255,255,0.40)", filter: "blur(6px)" }}
              >
                {c.value}
              </span>
            </div>
        ...
        <button
          ...
          className="w-full rounded-full py-2.5 text-sm font-bold text-white transition-all hover:opacity-90 active:scale-[0.98]"
    ...
    >
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <ShieldCheck className="h-4 w-4" style={{ color: "#389e29" }} />
          <p className="text-sm font-bold text-white">Contact information</p>
        </div>
        {!revealed && (
      ...
      >
        {contacts.map((c) => (
          <div key={c.label} className="flex items-center gap-3">
            <c.icon className="h-4 w-4" style={{ color: "#e05523" }} />
            <span
              className="select-all text-sm font-semibold text-white transition-all duration-300"
              style={{
